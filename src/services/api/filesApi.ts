...
import { providerSupportsFilesApi } from '../../utils/model/providers.js'
...
function assertFilesApiAvailable(): void {
  if (!providerSupportsFilesApi()) {
    throw new Error(
      'Anthropic Files API is unavailable when using non-Anthropic providers',
    )
  }
}
