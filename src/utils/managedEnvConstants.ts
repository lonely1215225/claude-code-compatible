import { getAllProviderDescriptors } from './model/providers.js'
 ...
 */
const PROVIDER_SELECTION_ENV_VARS = getAllProviderDescriptors()
  .map(descriptor => descriptor.selectionEnvFlag)
