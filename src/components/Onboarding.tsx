...
import { getConfiguredProviderForSetup, type ConfigurableProvider } from '../utils/providerConfig.js';
...
type StepId = 'provider' | 'preflight' | 'theme' | 'oauth' | 'api-key' | 'security' | 'terminal-setup';
...
export function Onboarding({
  ...
  const [selectedProvider, setSelectedProvider] = useState<ConfigurableProvider>(() => getConfiguredProviderForSetup());
  const oauthEnabled = selectedProvider === 'anthropic' && isAnthropicAuthEnabled();
  ...
  steps.push({
    id: 'provider',
    component: <ProviderSetupStep onDone={provider => {
